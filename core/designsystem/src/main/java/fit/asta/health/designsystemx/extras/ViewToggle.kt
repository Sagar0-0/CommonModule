...
fun AstaViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = AstaViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        AstaViewToggleButtonContent(
...
/**
 * Internal Asta view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun AstaViewToggleButtonContent(
...
/**
 * Asta view toggle default values.
 */
object AstaViewToggleDefaults {
    // TODO: File bug
