...
/**
 * Asta tab. Wraps Material 3 [Tab] and shifts text label down.
 *
    ...
    Tab(
        ...
        text = {
            ...
            ProvideTextStyle(
                value = style,
                content = {
                    Box(modifier = Modifier.padding(top = AstaTabDefaults.TabTopPadding)) {
                        text()
                    }
                },
            )
...
/**
 * Asta tab row. Wraps Material 3 [TabRow].
 *
 * @param selectedTabIndex The index of the currently selected tab.
 * @param modifier Modifier to be applied to the tab row.
 * @param tabs The tabs inside this tab row. Typically this will be multiple [AstaTab]s. Each element
