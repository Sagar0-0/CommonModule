package fit.asta.health.designsystem.components.unUsed
...
fun RatingDialogDemo() {
    ...
    if (showRatingDialog) {
        RatingDialog(rating = rating, onRatingChange = {
            rating = it
        }, onRateFinished = {
            rating = it
...
fun RatingDialog(
    ...
    Dialog(onDismissRequest = {
        ...
        Column(
            ...
            Text(
                text = "Do you love this App?", fontSize = 28.sp, fontWeight = FontWeight.Bold
            )
