...
/**
 * Asta toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
        ...
        colors = IconButtonDefaults.iconToggleButtonColors(
            ...
            disabledContainerColor = if (checked) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = AstaIconButtonDefaults.DisabledIconButtonContainerAlpha,
                )
            } else {
                Color.Transparent
            },
...
/**
 * Asta icon button default values.
 */
object AstaIconButtonDefaults {
    // TODO: File bug
