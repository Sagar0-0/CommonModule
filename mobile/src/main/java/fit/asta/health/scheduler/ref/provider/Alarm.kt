...
import fit.asta.health.scheduler.ref.provider.ClockContract.AlarmSettingColumns
import fit.asta.health.scheduler.ref.provider.ClockContract.AlarmsColumns
...
class Alarm : Parcelable, AlarmsColumns {
    ...
    constructor(c: Cursor) {
        ...
        if (c.columnCount == ALARM_JOIN_INSTANCE_COLUMN_COUNT) {
