...
//        return if (mLabel.isNullOrEmpty()) context.getString(R.string.label) else mLabel!!
//    }
//
//    /**
...
data class AlarmInstance(
    ...
    @ColumnInfo(name = "alarm_id") var mAlarmId: Long? = null,
    ...
    companion object {
        ...
        // ... Other constants and methods from the original class
        fun createIntent(action: String?, instanceId: Long): Intent {
            return Intent(action).putExtra("id", instanceId) //.setData(instanceId)
        }
