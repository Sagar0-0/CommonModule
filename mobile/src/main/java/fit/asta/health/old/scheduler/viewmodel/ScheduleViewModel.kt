package fit.asta.health.old.scheduler.viewmodel
...
import fit.asta.health.old.scheduler.data.ScheduleSessionData
import fit.asta.health.old.scheduler.data.ScheduleTimeData
import fit.asta.health.old.scheduler.tags.data.ScheduleTagData
import fit.asta.health.old.scheduler.ui.ScheduleAction
import fit.asta.health.old.scheduler.ui.ScheduleObserver
import kotlinx.coroutines.flow.catch
import kotlinx.coroutines.launch

class ScheduleViewModel(private val scheduleRepo: fit.asta.health.old.scheduler.ScheduleRepo) : ViewModel() {
