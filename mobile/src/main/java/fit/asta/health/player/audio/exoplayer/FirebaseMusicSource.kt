...
import fit.asta.health.player.audio.data.remote.MusicDatabase
...
class FirebaseMusicSource @Inject constructor(
    ...
    private suspend fun getAllSongs() = withContext(Dispatchers.IO) {
        ...
        songs = allSongs.map { song ->
            MediaMetadataCompat.Builder()
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_DISPLAY_DESCRIPTION, song.duration)
                .build()
        }
    }
    ...
    fun asMediaItems() = songs.map { song ->
        val desc = MediaDescriptionCompat.Builder()
            ...
            .setDescription(song.description.description)   // description is used to store duration
            .build()
