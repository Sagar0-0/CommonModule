...
import fit.asta.health.profile.feature.create.view.LifeStyleCreateBottomSheetType.PREFERREDACTIVITIES
...
import fit.asta.health.profile.feature.show.view.OnlyChipSelectionCard
...
import fit.asta.health.profile.feature.show.view.components.UserSleepCycles
    ...
    AppCard(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(vertical = AstaThemeX.appSpacing.medium)) {
            ...
            Row(
                ...
                Spacer(modifier = Modifier.width(AstaThemeX.appSpacing.large))
