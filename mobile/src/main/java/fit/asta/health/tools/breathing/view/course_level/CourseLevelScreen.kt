package fit.asta.health.tools.breathing.view.course_level
...
@Composable
fun CourseLevelScreen(
    onClick: (String) -> Unit,
    onBack: () -> Unit
) {
    val  itemList=listOf("Beginner 1", "Beginner 2", "Intermediate ", "Advanced", "Expert")
        ...
        LazyColumn(modifier = Modifier.padding(it)) {
            item {
                Text(
                    ...
                    text = "Select course level for your breathing exercise",
