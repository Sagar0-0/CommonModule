...
fun BreathingBreakTime(it: PaddingValues) {
    ...
    val itemListData = remember {
        mutableStateListOf(ItemData(1, "1 Minute", bgColor = Color(0x66959393)),
    ...
    ItemList(list = itemListData, rowTitle = "Select the break time for your breathing exercise", it = it)
